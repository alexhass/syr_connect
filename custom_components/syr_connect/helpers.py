...
_DEVICE_MODULES: dict[str, ModuleType] = {
    ...
    "muco_backwash": muco_backwash,
    "muco_connectioncentre": muco_connectioncentre,
    "muco_filling": muco_filling,
    "muco_leakprotect": muco_leakprotect,
    "muco_triolock": muco_triolock,
    "neosoft": neosoft,
    "safefloor": safefloor,
    "safetplus": safetplus,
    "trio": trio,
