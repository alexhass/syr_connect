...
async def test_async_setup_entry_with_input_datetime_sync(hass: HomeAssistant) -> None:
    """Test setup with input_datetime helper synchronization."""
    config_entry = ConfigEntry(
        version=1,
        minor_version=0,
        domain=DOMAIN,
    ...
    # Mock coordinator data with device info
    ...
    assert result is True
    # Verify state change listener was registered for input_datetime helper
